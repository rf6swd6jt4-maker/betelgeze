...
function staticNavigationResults(workspace: { name: string; slug: string }, query: string): SearchResult[] {
    ...
    const entries = [
        ...
        { id: "settings-leadgen-sources-general", type: "Settings", label: "General Source Category", description: "Broad lead-generation sources such as seed and web sources", href: workspaceHref(workspace.slug, "settings#leadgen-sources-general"), path: `${settingsPath} > Lead Gen Sources > General`, keywords: ["lead gen source category", "source categories", "general sources", "seed sources", "web crawler"] },
        { id: "settings-leadgen-sources-industry", type: "Settings", label: "Industry Source Category", description: "Trade, licensing, board, and industry-specific owner sources", href: workspaceHref(workspace.slug, "settings#leadgen-sources-industry"), path: `${settingsPath} > Lead Gen Sources > Industry-specific`, keywords: ["lead gen source category", "source categories", "industry sources", "trade sources", "license sources", "licensing"] },
        { id: "settings-leadgen-sources-location", type: "Settings", label: "Location Source Category", description: "State, county, city, property, clerk, registry, and local public-record sources", href: workspaceHref(workspace.slug, "settings#leadgen-sources-location"), path: `${settingsPath} > Lead Gen Sources > Location-specific`, keywords: ["lead gen source category", "source categories", "location sources", "county sources", "property appraiser", "clerk filings", "sunbiz"] },
    ]
