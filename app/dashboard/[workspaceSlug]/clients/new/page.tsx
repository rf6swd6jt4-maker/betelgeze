            ...
            <div className="flex min-h-screen items-center justify-center">
                <form action={createWorkspaceClient.bind(null, workspace.slug)} className="w-full max-w-lg rounded-2xl border border-neutral-800 bg-neutral-900 p-7">
                    ...
                    <label className="mt-6 block text-sm">
                        Client name
                        <input required name="name" className="mt-2 w-full rounded-lg border border-neutral-700 bg-neutral-950 px-3 py-3" />
                    </label>
                    <label className="mt-4 block text-sm">
                        Client email
                        <input type="email" name="email" className="mt-2 w-full rounded-lg border border-neutral-700 bg-neutral-950 px-3 py-3" />
                    </label>
                    <button className="mt-6 rounded-lg bg-white px-4 py-3 font-medium text-black">
