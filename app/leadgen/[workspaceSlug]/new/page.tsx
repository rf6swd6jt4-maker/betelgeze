...
function sourceRequirement(sourceKey: LeadgenSourceKey, hasSeedSource: boolean) {
    if (sourceKey === "overture") return process.env.OVERTURE_DUCKDB_ENDPOINT ? null : "Missing Overture adapter"
    ...
    return <main className="min-h-screen bg-neutral-950 px-5 py-8 text-white sm:px-8">
        <div className="mx-auto max-w-5xl">
            ...
            <section className="py-10">
                ...
                <h1 className="mt-3 text-3xl font-semibold tracking-tight">Confirm source polling</h1>
                <p className="mt-3 max-w-2xl text-sm leading-6 text-neutral-400">This is a standalone poll confirmation page. It captures the current ICP and checks which configured sources can actually run before creating the poll.</p>
            </section>
            ...
            <section className="grid gap-5 lg:grid-cols-[0.8fr_1.2fr]">
                ...
                <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-5">
                    <h2 className="text-lg font-semibold">Source readiness</h2>
