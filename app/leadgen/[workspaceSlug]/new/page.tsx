    ...
    return <main className="min-h-screen bg-neutral-950 px-4 pb-5 text-white sm:px-8 sm:pb-8">
        ...
        <div className="mx-auto max-w-5xl pt-5">
            <section className="py-6 sm:py-10">
                ...
                <p className="mt-3 max-w-3xl text-sm leading-6 text-neutral-400">This poll will seed new businesses from the current ICP, then run the staged v5.5.2 owner-identity system. Florida targets lean on Sunbiz external shards plus county property-appraiser records; California targets now avoid live CSLB form polling and use stable external owner shards for Los Angeles FBN, DataSF registered businesses, and CalRecycle records before a more targeted California owner-page crawl fills only the remaining gaps.</p>
            </section>
