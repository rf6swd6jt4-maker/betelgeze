...
export function WorkspaceIdentityEditor({ workspace, updateName, updateCoverLayout, uploadBanner, uploadLogo, product = "client-work", description = "Settings for this workspace.", bannerLabel = "dashboard banner", editable = true }: Props) {
