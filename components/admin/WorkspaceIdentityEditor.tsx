...
export function WorkspaceIdentityEditor({ workspace, updateName, updateCoverLayout, uploadBanner, uploadLogo, description = "Settings for this workspace.", bannerLabel = "dashboard banner", editable = true }: Props) {
