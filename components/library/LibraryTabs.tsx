...
export function LibraryTabs({ workspaceSlug, active, limited = false }: { workspaceSlug: string; active: "work-items" | "assets" | "sops" | "notes"; limited?: boolean }) {
    ...
    const items = limited ? [workItems, sops] : [
        ...
        { key: "notes", label: "Notes", href: `/${workspaceSlug}/notes` },
    ]
