...
export function ListCreatorBadge({ src, username, label, date }: { src?: string | null; username?: string | null; label: "Created by" | "Added by"; date: string }) {
    ...
    return <div className="group relative inline-flex shrink-0">
        ...
        <div className="pointer-events-none absolute right-0 top-9 z-[9999] hidden w-56 rounded-lg border border-neutral-800 bg-neutral-950 p-3 text-left shadow-2xl group-hover:block group-focus-within:block">
