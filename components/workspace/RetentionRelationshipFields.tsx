                    ...
                    return <ListItem key={service.id}><div className="space-y-3 px-3 py-3">
                        ...
                        {selection ? <>
                            ...
                            {config ? <div className="space-y-3">
                                ...
                                <fieldset><legend className="text-sm text-neutral-300">Information the setter should collect</legend><p className="mt-1 text-xs text-neutral-500">Name, date and time are always required. Choose any combination of extra fields. Selected information is visible to the client.</p>
