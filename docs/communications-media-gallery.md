...
- Repository suite: 890 passing tests; changed-file ESLint and whitespace check passed; production webpack build passed.
...
- Six session-policy tests cover promotion/cancellation, budget eviction and large selected items, failures/stalls, hidden/buffering suspension, unknown metadata, and late completions.
