...
| Mobile viewport | Workspace shell plus composer controller; standalone portal controller separately | One owner per surface, stable chrome, native selection/scroll, no user-agent forks; physical Android and iPhone evidence separate |
