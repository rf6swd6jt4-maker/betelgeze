...
const ATP_INDUSTRY_TERMS: Record<string, string[]> = {
    ...
    cleaning_companies: ["clean", "cleaning", "janitorial", "maid"],
    pest_control: ["pest", "exterminator", "termite"],
    lighting_contractors: ["lighting", "electric", "electrical"],
    auto_repair: ["auto", "automotive", "mechanic", "repair"],
    waste_disposal: ["waste", "junk", "recycling", "disposal", "sanitation"],
