...
export const leadgenSourceOptions: LeadgenSourceOption[] = [
    ...
    },
    {
        ...
        statusLabel: "Executable from public CSV",
        notesPlaceholder: "Business CSV matching rules, applicator/title filters, or pest-category caveats.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. Betelgeze reads the public TDA commercial-business CSV and treats the responsible applicator/operator as owner-identity evidence.",
    },
    {
        ...
        notesPlaceholder: "Registry endpoint, customer-role fields, or waste-program filters.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. Betelgeze submits the public Central Registry search and parses regulated-entity/customer affiliation rows.",
    },
    {
    ...
    },
    {
        ...
        detail: "Florida Division of Corporations Sunbiz entity records. Matches Florida businesses to officers, managers, registered agents, and annual-report names from compact external shards built from the official data downloads.",
        statusLabel: "Executable after shard URL is configured",
        notesPlaceholder: "Shard refresh notes, officer-title filters, or Sunbiz data vintage.",
        kind: "enrichment",
        category: "location",
        implemented: true,
    ...
    {
        value: "registry.fl.fictitious_names",
        label: "Florida Sunbiz fictitious names",
        detail: "Florida Division of Corporations fictitious-name records from compact external shards built from the official data downloads. Useful for sole proprietors, DBAs, and service businesses where the registrant is closer to a real owner identity than an entity name.",
        statusLabel: "Executable after shard URL is configured",
        notesPlaceholder: "Shard refresh notes, fictitious-name registrant filters, or Sunbiz search caveats.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        envVar: "SUNBIZ_SHARD_BASE_URL",
    ...
    },
    {
        ...
        notesPlaceholder: "FDACS license classes, certified-operator fields, stable endpoint, or dataset notes.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The public HTML search can time out or challenge automation; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        statusLabel: "Executable from guarded public search",
        notesPlaceholder: "Registration fields, stable endpoint, shop-status filters, or owner/contact confidence rules.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The public HTML business search can challenge automation; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        statusLabel: "Executable from guarded public search",
        notesPlaceholder: "County data export, stable receipt endpoint, receipt-status filters, or owner-field notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The public county-tax page can return a Cloudflare challenge; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        statusLabel: "Executable from guarded public search",
        notesPlaceholder: "BTR data export, stable endpoint, receipt-status filters, or owner-field notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The public page can return edge Access Denied responses; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The county-tax HTML path can challenge automation; the worker records that as a failed source task instead of a false owner result.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Executable with free DCA API credentials",
        notesPlaceholder: "BAR license classes, owner/contact fields, or station filters.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        envVars: ["DCA_SEARCH_APP_ID", "DCA_SEARCH_APP_KEY"],
        setupHint: "Set DCA_SEARCH_APP_ID and DCA_SEARCH_APP_KEY from California DCA's free Search API. The adapter uses board id 21 for BAR records.",
    },
    {
        ...
        implemented: true,
        envVars: ["DCA_SEARCH_APP_ID", "DCA_SEARCH_APP_KEY"],
        setupHint: "Set DCA_SEARCH_APP_ID and DCA_SEARCH_APP_KEY from California DCA's free Search API. The adapter uses board id 800 and type id 8002 for SPCB records.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Executable from public ArcGIS table",
    ...
    },
    {
        ...
        statusLabel: "Executable from public ArcGIS service",
    ...
    },
    {
        ...
        statusLabel: "Blocked until stable endpoint/export is configured",
        notesPlaceholder: "ROC API/app endpoint, license-class filters, qualifier fields, or challenge status.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "Keep this off for poll fan-out until a stable ROC endpoint, official export, or shard input replaces the guarded public page.",
    },
    {
        ...
        statusLabel: "Blocked until stable endpoint/export is configured",
        notesPlaceholder: "License categories, stable endpoint, qualifying-party fields, or business-name matching notes.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "Keep this off for poll fan-out until a stable pest-management endpoint, official export, or shard input replaces the guarded public page.",
    },
    {
        value: "registry.az.corp_commission",
        label: "Arizona Corporation Commission entity officers",
        detail: "Arizona Corporation Commission entity records from external owner shards. Matches AZ businesses to officers, members, managers, statutory agents, and entity filings without live portal scraping.",
        statusLabel: "Executable after shard URL is configured",
        notesPlaceholder: "ACC bulk/export refresh cadence, shard build notes, officer-title filters, or statutory-agent scoring notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        envVar: "AZ_OWNER_SHARD_BASE_URL",
        setupHint: "Set AZ_OWNER_SHARD_BASE_URL in Vercel after uploading generated ACC shards to R2 or another public object store.",
    },
    {
        value: "registry.az.trade_names",
        label: "Arizona Secretary of State trade names",
        detail: "Arizona Secretary of State trade-name and trademark records from external owner shards. Fills the DBA/sole-proprietor role for Arizona owner identity.",
        statusLabel: "Executable after shard URL is configured",
        notesPlaceholder: "SOS trade-name export refresh cadence, registrant field mapping, DBA alias rules, or entity-registrant notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        envVar: "AZ_OWNER_SHARD_BASE_URL",
        setupHint: "Set AZ_OWNER_SHARD_BASE_URL in Vercel after uploading generated Arizona trade-name shards to R2 or another public object store.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Executable from public CSV export",
        notesPlaceholder: "Permit endpoint, contractor-field mapping, or Phoenix work-type filters.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. Betelgeze reads Phoenix's public issued-permit CSV export and matches contractor names/phones.",
    },
    {
...
export function leadgenSourceEnvVars(source: { envVar?: string; envVars?: string[] }) {
    return [...(source.envVar ? [source.envVar] : []), ...(source.envVars ?? [])]
}

export function leadgenSourceRuntimeConfigured(key: LeadgenSourceKey) {
    const source = optionByKey.get(key)
    const vars = source ? leadgenSourceEnvVars({
        envVar: "envVar" in source ? source.envVar : undefined,
        envVars: "envVars" in source ? source.envVars : undefined,
    }) : []
    return vars.length === 0 || vars.every((envVar) => Boolean(process.env[envVar]))
}
