...
export const leadgenSourceOptions: LeadgenSourceOption[] = [
    ...
    },
    {
        ...
        statusLabel: "Executable when Sunbiz does not challenge the request",
        notesPlaceholder: "Entity-search parser notes, officer-title filters, or challenge status.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed, but Sunbiz can return a Cloudflare challenge. The adapter fails the task explicitly instead of recording a false success.",
    },
    {
        ...
        statusLabel: "Executable when FDACS search responds",
        notesPlaceholder: "FDACS license classes, certified-operator fields, or business-name filters.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The adapter queries the public FDACS pest company search and fails honestly if the endpoint times out or blocks polling.",
    },
    {
        ...
        statusLabel: "Executable when FDACS business search responds",
        notesPlaceholder: "Registration fields, shop-status filters, or owner/contact confidence rules.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The adapter uses the public FDACS business-search path and fails honestly when the public app is unavailable.",
    },
    {
        ...
        statusLabel: "Executable when county-tax search responds",
        notesPlaceholder: "County search endpoint, receipt-status filters, or owner-field notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The adapter tries the public county-tax receipt path and records a failed task when Cloudflare blocks access.",
    },
    {
        ...
        statusLabel: "Executable when Tampa search responds",
        notesPlaceholder: "BTR search endpoint, receipt-status filters, or owner-field notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. Tampa may geo-block non-US infrastructure; the adapter fails the task explicitly if that happens.",
    },
    {
        ...
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The adapter tries the Duval/Jacksonville county-tax path and records a failed task when the public site blocks access.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Executable when Bizfile does not challenge the request",
        notesPlaceholder: "Entity-search parser, filing-title filters, or registered-agent confidence notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed, but Bizfile can return an Incapsula challenge. The adapter fails the task explicitly instead of recording a false success.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Executable when Salesforce public search responds",
        notesPlaceholder: "ROC license-class filters, qualifier fields, or challenge status.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The adapter probes the public Salesforce search page and records an explicit failed task if the site does not expose searchable rows.",
    },
    {
        ...
        statusLabel: "Executable when AZ OPM search responds",
        notesPlaceholder: "License categories, qualifying-party fields, or business-name matching notes.",
        kind: "enrichment",
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The adapter queries the public OPM business-license search and fails honestly when Cloudflare blocks access.",
    },
    {
        ...
        statusLabel: "Executable when ACC public API responds",
        notesPlaceholder: "Entity-search parser notes, officer-title filters, or challenge status.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The adapter uses the public ACC portal endpoints when available and fails explicitly when the public portal requires recaptcha.",
    },
    {
