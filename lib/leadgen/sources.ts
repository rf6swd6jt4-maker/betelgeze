...
export const leadgenSourceOptions: LeadgenSourceOption[] = [
    ...
    },
    {
        ...
        detail: "Florida Division of Corporations Sunbiz entity records. Matches Florida businesses to officers, managers, registered agents, and annual-report names from the indexed official data downloads.",
        statusLabel: "Executable from indexed public download",
        notesPlaceholder: "Sunbiz bulk-download index status, officer-title filters, or refresh notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. Betelgeze queries the local index populated from official Sunbiz fixed-width downloads instead of the guarded live search page.",
    },
    {
        value: "registry.fl.fictitious_names",
        label: "Florida Sunbiz fictitious names",
        detail: "Florida Division of Corporations fictitious-name records from the indexed official data downloads. Useful for sole proprietors, DBAs, and service businesses where the registrant is closer to a real owner identity than an entity name.",
        statusLabel: "Executable from indexed public download",
        notesPlaceholder: "Fictitious-name registrant filters, status handling, or Sunbiz search caveats.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. Betelgeze queries the local index populated from official Sunbiz fixed-width downloads instead of the guarded live search page.",
    ...
    },
    {
        ...
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The public page may return a Salesforce app shell; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        category: "industry",
        implemented: true,
        setupHint: "No API key is needed. The public OPM HTML route can challenge automation; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        ...
        statusLabel: "Executable from guarded public search",
        notesPlaceholder: "ACC endpoint, entity-search parser notes, officer-title filters, or challenge status.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The ACC portal may return an app shell or recaptcha assets; the worker records that as a failed source task instead of a false owner result.",
    },
    {
