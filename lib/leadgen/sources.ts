...
export const leadgenSourceOptions: LeadgenSourceOption[] = [
    ...
    },
    {
        ...
        detail: "Florida Division of Corporations Sunbiz entity records. Matches Florida businesses to officers, managers, registered agents, and annual-report names from public corporation search results.",
        statusLabel: "Executable from public search",
        notesPlaceholder: "Sunbiz bulk-download index status, officer-title filters, or refresh notes.",
        kind: "enrichment",
        category: "location",
        implemented: true,
        setupHint: "No API key is needed. The public search can occasionally challenge automation; the worker records that as a failed source task instead of a false owner result.",
    },
    {
        value: "registry.fl.fictitious_names",
        label: "Florida Sunbiz fictitious names",
        detail: "Florida Division of Corporations fictitious-name records. Useful for sole proprietors, DBAs, and service businesses where the registrant is closer to a real owner identity than an entity name.",
        statusLabel: "Executable from public search",
