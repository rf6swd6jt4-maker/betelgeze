...
export const leadgenSourceOptions: LeadgenSourceOption[] = [
    ...
    },
    {
        ...
        statusLabel: "Bulk refresh needed",
        notesPlaceholder: "Sunbiz bulk-download index status, officer-title filters, or refresh notes.",
        kind: "enrichment",
        category: "location",
        setupHint: "Sunbiz has free daily and quarterly data downloads. Betelgeze should refresh and index those files before this source returns to poll-time use.",
    },
    {
        ...
        statusLabel: "Needs stable endpoint",
        notesPlaceholder: "FDACS license classes, certified-operator fields, stable endpoint, or dataset notes.",
        kind: "enrichment",
        category: "industry",
        setupHint: "The public HTML search is too timeout/challenge-prone for poll fan-out. Add a stable FDACS endpoint, data extract, or source-specific parser before activation.",
    },
    {
        ...
        kind: "enrichment",
        category: "industry",
        setupHint: "The public HTML business search is not stable enough for poll fan-out. Add a source-specific endpoint or dataset path before activation.",
    },
    {
        ...
        kind: "enrichment",
        category: "location",
        setupHint: "The public county-tax page currently returns a Cloudflare challenge to automation. Keep listed for targeting, but do not run until a stable endpoint or export is available.",
    },
    {
        ...
        kind: "enrichment",
        category: "location",
        setupHint: "The current public page can return edge Access Denied responses to poll infrastructure. Add a stable endpoint or export before activation.",
    },
    {
        ...
        kind: "enrichment",
        category: "location",
        setupHint: "The county-tax HTML path is not robust enough for poll fan-out. Keep listed, but require a stable endpoint or export before activation.",
    },
    {
    ...
    },
    {
        ...
        kind: "enrichment",
        category: "location",
        setupHint: "The public Bizfile HTML route can challenge automation. Add a verified source-specific endpoint or bulk data path before poll-time activation.",
    },
    {
    ...
    },
    {
        ...
        statusLabel: "Needs source-specific endpoint",
        notesPlaceholder: "ROC API/app endpoint, license-class filters, qualifier fields, or challenge status.",
        kind: "enrichment",
        category: "location",
        setupHint: "The public page returns a Salesforce app shell rather than server-rendered records. Add a verified source-specific endpoint before activation.",
    },
    {
        ...
        kind: "enrichment",
        category: "industry",
        setupHint: "The public OPM HTML route can challenge automation. Add a stable endpoint, export, or source-specific parser before activation.",
    },
    {
        ...
        kind: "enrichment",
        category: "location",
        setupHint: "The current ACC portal is an app shell with recaptcha assets. Add a verified endpoint or dataset path before poll-time activation.",
    },
    {
