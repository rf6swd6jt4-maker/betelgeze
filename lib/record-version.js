...
/** @param {{createdAt:string,id:string}} left @param {{createdAt:string,id:string}} right */
export function compareChatMessages(left, right) {
    return recordVersionKey(left.createdAt).localeCompare(recordVersionKey(right.createdAt)) || left.id.localeCompare(right.id)
}
