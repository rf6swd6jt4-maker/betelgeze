...
export async function loadNativeRelationships(workspaceSlug: string, relationshipId?: string) {
...
export type NativeRelationshipsSnapshot = Awaited<ReturnType<typeof loadNativeRelationships>>
