...
try {
 ...
 console.log('PASS: portal/onboarding share one account; permissions, revocation, duplicates, leases, cooldowns, config rotation, stale writes and report isolation')
