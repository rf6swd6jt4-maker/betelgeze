...
with source_health_updates(source_key, status, last_error, metadata_patch) as (
    values
        ('registry.fl.sunbiz', 'blocked', 'Official Sunbiz data downloads must be refreshed/indexed before this source can run in polls.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"bulk_refresh_required"}'::jsonb),
        ('state_license.fl.fdacs_pest', 'blocked', 'Stable FDACS pest endpoint or extract is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"needs_endpoint"}'::jsonb),
        ('state_license.fl.fdacs_auto_repair', 'blocked', 'Stable FDACS motor-vehicle-repair endpoint or extract is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"needs_endpoint"}'::jsonb),
        ('registry.fl.miami_dade_lbt', 'blocked', 'Cloudflare challenge observed on the public county-tax search path.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","guarded_surface":"cloudflare","source_status":"needs_endpoint"}'::jsonb),
        ('registry.fl.tampa_btr', 'blocked', 'Edge Access Denied observed on the public Tampa BTR search path.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","guarded_surface":"akamai","source_status":"needs_endpoint"}'::jsonb),
        ('registry.fl.jacksonville_btr', 'blocked', 'Stable Jacksonville/Duval BTR endpoint or export is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"needs_endpoint"}'::jsonb),
        ('registry.ca.bizfile', 'blocked', 'Stable California Bizfile endpoint or bulk data path is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"needs_endpoint"}'::jsonb),
        ('state_license.az.roc', 'blocked', 'Salesforce app shell observed; source-specific endpoint is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","guarded_surface":"salesforce_app_shell","source_status":"needs_endpoint"}'::jsonb),
        ('state_license.az.pest_management', 'blocked', 'Stable Arizona pest-management endpoint or extract is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","source_status":"needs_endpoint"}'::jsonb),
        ('registry.az.corp_commission', 'blocked', 'ACC portal app shell and recaptcha assets observed; stable endpoint or dataset is required before poll-time activation.', '{"disabled_by":"20260701023000_harden_fragile_public_record_sources","guarded_surface":"recaptcha_app_shell","source_status":"needs_endpoint"}'::jsonb)
)
